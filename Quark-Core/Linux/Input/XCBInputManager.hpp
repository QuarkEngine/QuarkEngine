...
{
	//!
	//! \brief The XCB input manager implementation
	//!
	class XCBInputManager final : public InputManager
	{
	public:
		//!
		//! \brief Constructs an instance of XCBInputManager
		//!
		XCBInputManager();

		//!
		//! \brief Destructs the instance of XCBInputManager
		//!
		~XCBInputManager();
	public:
		//!
	...
	private:
		std::unordered_map<Key, std::vector<KeyCallback>> mKeyCallbacks;
		std::unordered_map<MouseButton, std::vector<MouseButtonCallback>> mMouseButtonCallbacks;
